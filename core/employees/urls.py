...
from employees.views import EmployeeListView, EmployeeCreateView, EmployeeDetailView, EmployeeUpdateView, ajx_employee_list, ajx_import_insert_excel_employees_celery, ajx_import_update_excel_employees_celery, ajx_tasks_status
