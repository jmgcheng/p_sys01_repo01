window.addEventListener('DOMContentLoaded', () => {
    console.log('inventory_deduct_form.js ready');
  
    const formset = document.getElementById("formset");
    // id_inventory_deduct_detail-TOTAL_FORMS auto created by {{ formset.management_form }}
    const totalForms = document.getElementById('id_inventory_deduct_detail-TOTAL_FORMS');
