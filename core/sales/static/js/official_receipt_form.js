window.addEventListener('DOMContentLoaded', () => {
    console.log('official_receipt_form.js ready');
  
    const formset = document.getElementById("formset");
    // id_official_receipt_detail-TOTAL_FORMS auto created by {{ formset.management_form }}
    const totalForms = document.getElementById('id_official_receipt_detail-TOTAL_FORMS');
