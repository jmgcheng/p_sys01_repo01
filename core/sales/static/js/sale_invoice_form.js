window.addEventListener('DOMContentLoaded', () => {
    console.log('sale_invoice_form.js ready');
  
    const formset = document.getElementById("formset");
    // id_sale_invoice_detail-TOTAL_FORMS auto created by {{ formset.management_form }}
    const totalForms = document.getElementById('id_sale_invoice_detail-TOTAL_FORMS');
