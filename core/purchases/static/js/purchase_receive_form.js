window.addEventListener('DOMContentLoaded', () => {
    console.log('purchase_receive_form.js ready');
  
    const formset = document.getElementById("formset");
    // id_purchase_receive_detail-TOTAL_FORMS auto created by {{ formset.management_form }}
    const totalForms = document.getElementById('id_purchase_receive_detail-TOTAL_FORMS');
