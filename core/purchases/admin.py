...
from purchases.models import PurchaseRequestStatus, PurchaseRequestHeader, PurchaseRequestDetail, PurchaseReceiveStatus, PurchaseReceiveHeader, PurchaseReceiveDetail
...
admin.site.register(PurchaseReceiveStatus)
