...
class Command(BaseCommand):
    help = "Insert purchase request details from an Excel file."

    def add_arguments(self, parser):
        parser.add_argument(
            'filename', type=str, help="The Excel file (XLSX) containing purchase request details.")
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(
            "purchase request Details data import completed!"))
