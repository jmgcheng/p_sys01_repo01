...
from products.utils import insert_excel_products


class Command(BaseCommand):
    help = 'Insert new products from a given XLSX file'
    ...
    def handle(self, *args, **kwargs):
        ...
        if insert_excel_products(df):
            self.stdout.write(self.style.SUCCESS(
                'Successfully inserted new products.'))
        else:
            raise CommandError("Command insert_excel_products fail")
